...
describe Dessert do
  ...
  let(:cake) { Dessert.new("cake", 12, chef) }
  ...
  describe "#initialize" do
    ...
    it "raises an argument error when given a non-integer quantity" do 
      expect { cake.quantity("cake", "hello", "'hi") }.to raise_error(ArgumentError)
    end
  end
  ...
  describe "#eat" do
    ...
    it "raises an error if the amount is greater than the quantity" do
      expect { cake.eat(13) }.to raise_error("not enough left!")
    end
  end
 ...
 describe "#serve" do
    it "contains the titleized version of the chef's name" do 
      ...
      expect(cake.serve).to eq("Chef Tucker the Great Baker has made 12 cakes!")
    end
  end
